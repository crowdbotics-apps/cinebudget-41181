"""
Django settings for cinebudget_41181 project.
...
ROOT_URLCONF = 'cinebudget_41181.urls'
...
WSGI_APPLICATION = 'cinebudget_41181.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cinebudget_41181 API",
    "DESCRIPTION": "API documentation for cinebudget_41181 App",
    "VERSION": "v1",
}
